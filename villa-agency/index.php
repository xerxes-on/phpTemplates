      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            ...
            <a href="?page=property-details"><img src="assets/images/featured-icon.png" alt="" style="max-width: 60px; padding: 0px;"></a>
          </div>
        </div>
        <div class="col-lg-5">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="icon-button">
                        <a href="?page=property-details"><i class="fa fa-calendar"></i> Schedule a visit</a>
                      </div>
                    </div>
                  </div>
                </div>
